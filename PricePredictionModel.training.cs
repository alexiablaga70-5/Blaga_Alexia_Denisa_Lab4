...
namespace Blaga_Alexia_Denisa_Lab4
{
    public partial class PricePredictionModel
    {
        public const string RetrainFilePath =  @"C:\Users\User\Downloads\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=37,MinimumExampleCountPerLeaf=29,NumberOfTrees=51,MaximumBinCountPerFeature=682,FeatureFraction=0.9981827801652152,LearningRate=0.1014694451539639,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",DiskTranspose=false}));
